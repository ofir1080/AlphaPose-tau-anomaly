...
from alphapose.utils.pPose_nms import pose_nms, write_json, process_res_json
...
class DataWriter():
    def __init__(self, cfg, opt, save_video=False,
        ...
        self.final_result = mp.Manager().list()
